...
``agent.request_cycle.run_request_cycle``.
...
from agent import request_cycle
...
def test_nous_provider_is_in_oauth_401_set():
    ...
    """
    source = inspect.getsource(request_cycle.run_request_cycle)
    ...
    assert needle in source, (
        ...
        "actionable-401-guidance branch of run_request_cycle."
    )
