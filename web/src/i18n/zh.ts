...
export const zh: Translations = {
  ...
  oauth: {
    ...
    proxy: {
      ...
      badgeProxy: "代理 {host}",
      badgeInvalid: "代理配置无效",
      invalidHint: "已保存的代理值无法解析，请重新输入地址以覆盖它。",
      test: "测试",
      testing: "测试中…",
      save: "保存",
      saving: "保存中…",
      saved:
        "{provider} 的代理已保存，新请求无需重启即可生效。保存会重写 config.yaml，其中的注释会丢失。",
      urlRequired: "请输入代理地址，或改选其他模式。",
      redactedUrl: "该地址是用于展示的脱敏形式，请输入完整代理地址（含凭据）。",
      resultReachable: "可达 —— 返回 {status}。",
      resultHttp: "返回 {status}。连接已建立，但请自行判断该状态码是否符合预期。",
      resultTransportError: "无法连接：{detail}",
    },
  },
