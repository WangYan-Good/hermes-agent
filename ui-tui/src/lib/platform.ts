 ...
 */
export const isRedrawShortcut = (key: { ctrl: boolean; meta: boolean; super?: boolean }, ch: string): boolean =>
  isAction(key, ch, 'l') || (key.ctrl && !key.meta && key.super !== true && ch.toLowerCase() === 'l')
